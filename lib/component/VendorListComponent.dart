...
class VendorListComponentState extends State<VendorListComponent> {
  ...
  Widget getVendorWidget(VendorResponse vendor, BuildContext context, String? value) {
          ...
          Stack(
            children: [
              Container(
                width: 130,
                height: 200,
                child: Image.asset(ic_vendor_background, fit: BoxFit.fitHeight).cornerRadiusWithClipRRectOnly(topLeft: defaultRadius.toInt(), bottomLeft: defaultRadius.toInt()),
              ),
              Container(
                height: 150,
                width: 130,
                decoration: boxDecorationWithRoundedCorners(border: Border.all(color: white, width: 4), borderRadius: radius(0)),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  4.width,
                  Text(value!, style: secondaryTextStyle(color: textSecondaryColor.withOpacity(0.6))),
                ],
              )
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, i) {
          return getVendorWidget(mVendorList[i], context, appLocalization!.translate('lbl_explore')).onTap(() {
