...
class ProductComponent1 extends StatefulWidget {
  static String tag = '/ProductComponent1';
  final double? width;
  final ProductResponse? mProductModel;

  ProductComponent1({Key? key, this.width, this.mProductModel})
      : super(key: key);

  @override
  ProductComponent1State createState() => ProductComponent1State();
}

class ProductComponent1State extends State<ProductComponent1> {
