...
class HomeCategoryListComponent1 extends StatelessWidget {
  const HomeCategoryListComponent1({Key? key, required this.mCategoryModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('${appLocalization.translate("lbl_category")!.toUpperCase()}', style: GoogleFonts.alegreyaSc(color: primaryColor!, fontSize: 22)).paddingOnly(left: 12, right: 12, bottom: 8),
        8.height,
        Container(
          height: 200,
          ...
          child: GridView.builder(
            ...
            shrinkWrap: true,
            gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(maxCrossAxisExtent: 150, childAspectRatio: 1, crossAxisSpacing: 14, mainAxisSpacing: 4),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        decoration:
                            boxDecorationWithRoundedCorners(boxShape: BoxShape.circle, gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [primaryColor!, blueColor.withOpacity(0.3)])),
