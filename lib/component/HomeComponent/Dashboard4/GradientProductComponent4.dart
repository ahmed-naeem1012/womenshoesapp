...
class GradientProductComponent4 extends StatefulWidget {
  static String tag = '/GradientProductComponent';
  final double? width;
  final ProductResponse? mProductModel;

  GradientProductComponent4({Key? key, this.width, this.mProductModel})
      : super(key: key);

  @override
  GradientProductComponent4State createState() =>
      GradientProductComponent4State();
}

class GradientProductComponent4State extends State<GradientProductComponent4> {
