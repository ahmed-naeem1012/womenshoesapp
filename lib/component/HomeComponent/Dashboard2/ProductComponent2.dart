...
class ProductComponent2 extends StatefulWidget {
  static String tag = '/ProductComponent';
  final double? width;
  final ProductResponse? mProductModel;

  ProductComponent2({Key? key, this.width, this.mProductModel})
      : super(key: key);

  @override
  ProductComponent2State createState() => ProductComponent2State();
}

class ProductComponent2State extends State<ProductComponent2> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            RatingBar.builder(
              initialRating: widget.mProductModel!.ratingCount!.toDouble(),
              ignoreGestures: true,
              ...
              onRatingUpdate: (rating) {
                ...
                .visible(widget.mProductModel!.ratingCount!.toDouble() != 0),
