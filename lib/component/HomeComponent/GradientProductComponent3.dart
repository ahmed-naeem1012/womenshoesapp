...
class GradientProductComponent3 extends StatefulWidget {
  static String tag = '/GradientProductComponent';
  final double? width;
  final ProductResponse? mProductModel;

  GradientProductComponent3({Key? key, this.width, this.mProductModel})
      : super(key: key);

  @override
  GradientProductComponent3State createState() =>
      GradientProductComponent3State();
}

class GradientProductComponent3State extends State<GradientProductComponent3> {
