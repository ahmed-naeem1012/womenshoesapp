              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    mWishListModel[index].inStock == true
                        ? Text(appLocalization.translate('lbl_add_to_basket')!,
                            ...
                            .center()
                        : Text(appLocalization.translate('lbl_out_of_stock')!,
                                style: boldTextStyle(
                                    size: 14, color: primaryColor!))
                            .paddingOnly(bottom: 8)
                            .center(),
