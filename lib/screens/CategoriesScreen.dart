...
import 'package:woobox/component/CategoryComponent/CategoryListComponent.dart';
import 'package:woobox/component/CategoryComponent/GalleryViewComponent.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: mTop(
        ...
        actions: [
          Image.asset(ic_dashboard, height: 20, width: 20, color: white).onTap(() {
            isListView = false;
            setState(() {});
          }),
          16.width,
            ...
            mCategoryModel != null
                ? mCategoryModel!.isNotEmpty
                    ? SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            isListView == false ? GalleryViewComponent(mCategoryModel!) : CategoryListComponent(mCategoryModel!),
