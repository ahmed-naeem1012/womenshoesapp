...
import 'package:woobox/component/ThemeSelectionComponent.dart';
              ...
              children: [
                ...
                SettingItemWidget(
                  ...
                  subTitleTextStyle:
                      secondaryTextStyle(color: textSecondaryColor),
                  leading:
                      Icon(AntDesign.gift, size: 24, color: textSecondaryColor),
                  padding:
                ...
                SettingItemWidget(
                  padding:
                      EdgeInsets.only(left: 26, right: 8, top: 4, bottom: 4),
                  title: '${appLocalization.translate('lbl_terms_conditions')}',
                  trailing: Icon(Icons.chevron_right, color: context.iconColor),
                  onTap: () {
                    redirectUrl(
                        getStringAsync(TERMS_AND_CONDITIONS).isEmptyOrNull
                            ? TERMS_CONDITION_URL
                            : getStringAsync(TERMS_AND_CONDITIONS));
                  },
                  titleTextStyle: primaryTextStyle(),
                ),
                Divider(
                ...
                SettingItemWidget(
                  ...
                  trailing: Icon(Icons.chevron_right, color: context.iconColor),
                  onTap: () {
                    redirectUrl(getStringAsync(PRIVACY_POLICY).isEmptyOrNull
                        ? PRIVACY_POLICY_URL
                        : getStringAsync(PRIVACY_POLICY));
                  },
                  titleTextStyle: primaryTextStyle(),
                ),
                Divider(
                ...
                AppButton(
                  ...
                  shapeBorder: RoundedRectangleBorder(
                      borderRadius: radius(), side: BorderSide(width: 0.1)),
                  elevation: 0,
