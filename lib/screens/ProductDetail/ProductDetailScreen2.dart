          ...
          builder: (BuildContext ctx, Duration? remaining) {
            ...
            return DottedBorderWidget(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Image.asset(ic_offer_sell,
                        height: 20, width: 20, color: context.iconColor),
                    8.width,
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(appLocalization!.translate('lbl_offer_for_you')!,
                            style: boldTextStyle()),
                        Row(
...
// API calling for remove cart
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(ic_offer,
                            height: 25, width: 25, color: context.iconColor)
                        .paddingTop(4),
                    16.width,
                    createRichText(list: [
                      TextSpan(
    ...
    /* Widget _review() {
      return mReviewModel.isNotEmpty
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(appLocalization.translate("lbl_view_all")!, style: boldTextStyle(color: primaryColor)).onTap(() async {
                ...
                ).paddingOnly(top: 8, left: 16, right: 16).visible(mReviewModel.isNotEmpty),
                ListView.separated(
                    ...
                    return Row(
                      ...
                      children: [
                        mProfileImage!.isNotEmpty
                            ? CircleAvatar(backgroundImage: NetworkImage(mProfileImage.validate()), radius: 25)
                            : CircleAvatar(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      2.width,
                                      Icon(Icons.star_border, size: 12, color: whiteColor)
                                    ],
                                  ),
                                ),
                                6.width,
                                Text(parseHtmlString(mReviewModel[index].review.toString()), style: primaryTextStyle()).expand(),
                              ],
                            ),
                          ],
                        ).expand(),
          ...
          : Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(appLocalization!.translate("lbl_view_all_customer_review")!, style: boldTextStyle()),
    ...
    Widget mGroupAttribute(List<ProductDetailResponse> product) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(appLocalization!.translate('lbl_product_include')!,
                  style: boldTextStyle())
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: [
                            2.height,
                            Text(product[i].name!, style: boldTextStyle())
                                .paddingOnly(
                                    left: spacing_standard.toDouble(),
                            ...
                            Row(
                              children: [
                                ...
                                PriceWidget(
                                        price:
                                            product[i].regularPrice.toString(),
                                        size: 12,
                                        isLineThroughEnabled: true,
                                        color: Theme.of(context)
                                            .textTheme
                              ...
                              if (product[i].inStock == true) {
                                if (product[i].type == 'external') {
                                  ...
                                  ExternalProductScreen(
                                          mExternal_URL: product[i].externalUrl,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        if (mainProduct!.onSale == true)
                          ...
                          ).paddingOnly(left: 16, right: 12),
                        6.height.visible(mainProduct!.onSale == true),
                        Text(mainProduct!.name!, style: boldTextStyle(size: 18))
                            .paddingOnly(left: 16, bottom: 4),
                        6.height.visible(mainProduct!.type != "grouped"),
                        Row(
                          children: [
                            mPrice
                                .expand()
                        ...
                        ).paddingOnly(left: 18, right: 16).visible(
                            mainProduct!.type != "grouped" &&
                                productDetailNew!.onSale == true),
                      ],
                    ),
                    // Sale timer
                    ...
                    HtmlWidget(
                            postContent: mainProduct!.shortDescription,
                    ...
                    mainProduct!.store!.shopName!.isNotEmpty
                        ? Row(
                            ...
                            VendorProfileScreen(
                                ...
                                .launch(context);
                          }).paddingOnly(left: 16, top: 8, right: 12)
                        : SizedBox(),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        .visible(mReviewModel.isNotEmpty),
                    8.height.visible(mainProduct!.upSellIds!.isEmpty),
                    // Upsell
