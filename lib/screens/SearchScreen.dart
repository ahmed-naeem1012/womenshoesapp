import 'package:woobox/component/HomeComponent/Dashboard1/ProductComponent1.dart';
import 'package:woobox/model/ProductAttribute.dart';
import 'package:woobox/model/ProductResponse.dart';
import 'package:woobox/model/SearchRequest.dart';
...
class SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget body = StaggeredGridView.countBuilder(
      ...
      itemBuilder: (_, index) {
        return Container(margin: EdgeInsets.all(6.0), child: ProductComponent1(mProductModel: mProductModel[index]));
      },
    );
            ...
            AppBar(
                ...
                actions: [
                  ...
                  IconButton(
                      ...
                      icon: Icon(Icons.filter_alt, size: 24, color: Colors.white))
                ],
          ...
          children: <Widget>[
            SingleChildScrollView(
              ...
              child: Column(children: [
                body,
                mProgress().paddingAll(spacing_standard_new.toDouble()).visible(appStore.isLoading! && page > 1),
              ]),
            ).visible(mProductModel.isNotEmpty),
            mProgress().center().visible(appStore.isLoading! && page == 1),
            EmptyScreen().center().visible(mErrorMsg.isNotEmpty && !appStore.isLoading! && mProductModel.isEmpty),
          ],
        ),
      ),
    );
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(widget.mAttributeModel[index].name!, style: boldTextStyle(size: 16)),
                    8.height,
          ...
          children: [
            Container(
              ...
              decoration: boxDecorationWithRoundedCorners(
                ...
                borderRadius: radius(),
                border: Border.all(color: widget.mAttributeModel[index].terms![i].isSelected! ? primaryColor! : Theme.of(context).textTheme.subtitle2!.color!.withOpacity(0.1)),
              ),
              child: Text(
                widget.mAttributeModel[index].terms![i].name!,
                style: secondaryTextStyle(
                  size: 14,
                  color: widget.mAttributeModel[index].terms![i].isSelected! ? primaryColor : Theme.of(context).textTheme.subtitle1!.color,
                ),
              ),
            ),
          ],
