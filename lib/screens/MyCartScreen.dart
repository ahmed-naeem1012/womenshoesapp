...
import 'package:woobox/model/Countries.dart';
        ...
        return Row(
          ...
          () async {
            ...
            if (builderResponse.productdetailview!.layout == 'productDetail1') {
              ...
              // }
              // //Kashif --end
              ProductDetailScreen1(mProId: mCartModelList[i].proId)
                  .launch(context);
              ...
              // }
              // //Kashif --end
              ProductDetailScreen2(mProId: mCartModelList[i].proId)
                  .launch(context);
            } else {
              // //Kashif --start
              // await _createInterstitialAd();
              ...
              // }
              // //Kashif --end
              ProductDetailScreen3(mProId: mCartModelList[i].proId)
                  .launch(context);
            }
          },
        );
    ...
    Widget mEmptyBasket() {
      return Column(
        ...
        children: [
          ...
          8.height,
          Text(appLocalization.translate("msg_empty_basket_massage")!,
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            !mIsLoggedIn
                ? mEmptyBasket().visible(!appStore.isLoading!)
                : Stack(
                    children: [
                      mBody.visible(mCartModelList.isNotEmpty),
                      mEmptyBasket().center().visible(mCartModelList.isEmpty),
