...
import 'package:woobox/model/Line_items.dart';
import 'package:woobox/model/OrderModel.dart';
import 'package:woobox/model/OrderTracking.dart';
import 'package:woobox/model/TrackingResponse.dart';
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void getTotleAmount() {
    print("widget.mOrderModel:${widget.mOrderModel!.lineItems!.length}");
    ...
    for (var i = 0; i < widget.mOrderModel!.lineItems!.length; i++) {
      ...
      mTotalMrpDiscount -= (mTotalMrp *
          (mTotalMrp * widget.mOrderModel!.discountTotal.toInt()) /
          100);
      print("1product:${widget.mOrderModel!.lineItems![i].subtotal}");
      print("product:$mTotalMrp");
    }
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                    width: context.width(),
                                    child:
                                        DashedRect(gap: 3, color: greyColor)),
                                Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
