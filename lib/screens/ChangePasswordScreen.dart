              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(appLocalization.translate('update_password')!,style: boldTextStyle(size: 22)).paddingAll(16),
                    20.height,
                    AppTextField(
                      textFieldType: TextFieldType.PASSWORD,
                      controller: oldPasswordCont,
                      decoration: inputDecoration(context, hint: appLocalization.translate('hint_old_password')),
                      validator: (v){
                    ...
                    AppTextField(
                      ...
                      decoration: inputDecoration(context, hint: appLocalization.translate('lbl_new_pwd')),
                      validator: (v){
                    ...
                    AppTextField(
                      ...
                      decoration: inputDecoration(context, hint: appLocalization.translate('hint_confirm_password')),
                      validator: (v){
                        if (v!.trim().isEmpty) return appLocalization.translate('error_confirm_pwd_require');
                        if (!newPasswordCont.text.toString().contains(confirmPasswordCont.text.toString())) return appLocalization.translate('error_pwd_match');
                        return null;
                      },
                    ).paddingOnly(right: 16, left: 16),
                    28.height,
                    AppButton(
                        ...
                        onTap: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            toast(appLocalization.translate("toast_txt_change_pass"));
                          }
                        },

                        color: primaryColor).paddingOnly(right: 16, left: 16)
                  ],
                ),
              ),
