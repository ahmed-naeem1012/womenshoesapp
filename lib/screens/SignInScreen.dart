...
class SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    saveAppleData(result) async {
      setValue('appleEmail', result.credential.email);
      setValue('appleGivenName', result.credential.fullName.givenName);
      setValue('appleFamilyName', result.credential.fullName.familyName);
